...
[[20]](https://github.com/rosacarla/Mentoria-GFT-orientacao-a-objetos-Java/blob/master/java-classes-poo/src/dio/com/java/CurrentAccount.java) - conta corrente, atrib.(nº conta, nome correntista, saldo), mét.(depósito, saque), construtor(saldo opcional, valor default 0)  
[[21]](https://github.com/rosacarla/Mentoria-GFT-orientacao-a-objetos-Java/blob/master/java-classes-poo/src/dio/com/java/Rectangle.java) - retângulo, atrib.(LadoA, LadoB ou Compr+Larg, Base+Alt), mét.(muda val. lados, retorna val. lados, calcula área e perímetro)  
